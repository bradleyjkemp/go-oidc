...
func (v *IDTokenVerifier) Verify(ctx context.Context, rawIDToken string) (*IDToken, error) {
	...
	if !v.config.SkipIssuerCheck && t.Issuer != v.issuer {
		...
		shouldSkipItsGoogle := v.issuer == issuerGoogleAccounts && t.Issuer == issuerGoogleAccountsNoScheme
		...
		shouldSkipItsMicrosoftCommon := v.issuer == issuerMicrosoftAccountCommon && issuerMicrosoftAccountCommonTenant.MatchString(t.Issuer)
